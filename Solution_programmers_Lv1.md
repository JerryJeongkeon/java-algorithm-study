...
입력으로 주어지는 문자열 strings배열을 바로 정렬하였습니다.



문제 조건에 맞게 정렬하기 위해 Comparator를 사용하였습니다.



charAt() n번째의 문자로 정렬해주었으며,



만약 n번째의 문자가 같을 경우에는 사전순으로 compareTo 함수를 이용하여 정렬해주었습니다.
